// ---------------------------------------------------------------------------
// - Main.cpp                                                                -
// - iato:iaio client - main program implementation                          -
// ---------------------------------------------------------------------------
// - (c) inria 2002-2004                                                     -
// ---------------------------------------------------------------------------
...
int main (int argc, char** argv) {
  ...
  try {
    ...
    stx->setstr   ("STAT-FILE-NAME",            sname);
    stx->setlong  ("MAXIMUM-CYCLE-COUNT",       maxcc);
    stx->setlong  ("MAXIMUM-INSTRUCTION-COUNT", maxic);
