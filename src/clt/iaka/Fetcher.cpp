// ---------------------------------------------------------------------------
// - Fetcher.cpp                                                             -
// - iato:iaka client - instruction fetch class implementation               -
// ---------------------------------------------------------------------------
// - (c) inria 2002-2004                                                     -
// ---------------------------------------------------------------------------
...
namespace iato {
  ...
  Fetcher::Fetcher (Atx* atx) : Resource (RESOURCE_FTC) {
    d_dflg = atx->getbool ("DISPERSE-FLAG");
    d_iwsz = d_dflg ? atx->getiwsz () : 1;
    p_bndl = new Bundle[d_iwsz];
    p_imem = 0;
    reset ();
  }
