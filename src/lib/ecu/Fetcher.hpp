// ---------------------------------------------------------------------------
// - Fetcher.hpp                                                             -
// - iato:ecu library - instruction fetch class definition                   -
// ---------------------------------------------------------------------------
// - (c) inria 2002-2004                                                     -
// ---------------------------------------------------------------------------
...
namespace iato {
  ...
  /// issue width in disperse mode or is one by default. The class is designed
  /// to operate within an emulation environment.
