// ---------------------------------------------------------------------------
// - Mexecute.hpp                                                            -
// - iato:isa library - M execution unit class definition                    -
// ---------------------------------------------------------------------------
// - (c) inria 2002-2004                                                     -
// ---------------------------------------------------------------------------
...
#ifndef  IATO_MEXECUTE_HPP
#define  IATO_MEXECUTE_HPP
...
namespace iato {
  ...
  /// The Mexecute class is the M execution unit. The class is derived from
  /// the A execution unit.

  class Mexecute : public Aexecute {
  public:
